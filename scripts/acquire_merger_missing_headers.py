...
SAMPLE = ROOT / "evidence/merger-cached-item-screen-20260913/missing_header_queue.json"
...
async def main():
    ...
    assert len(frame) == 739 and not frame.accession.duplicated().any()
    unique = frame
        ...
        json.dumps(
            {
                ...
                "scope": "739 sealed missing headers only; no filing bodies, labels or returns",
                "concurrency": 2,
