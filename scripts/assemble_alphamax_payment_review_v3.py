...
R=Path(__file__).resolve().parents[1];S=R/'evidence/alphamax-payment-source-full-20260913';O=R/'evidence/alphamax-payment-schedule-review-v3-20260913'
...
assert len(accepted)==3284 and len(unresolved)==182 and len(review)==len(accepted)
