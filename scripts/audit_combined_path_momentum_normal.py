...
R=Path(__file__).resolve().parents[1];D=R/'artifacts/analysis/combined_path_momentum_20260913/normal';B=R/'artifacts/analysis/bil_cash_20260913/normal/daily.csv';C=R/'artifacts/analysis/alphamax_path_momentum_20260913/candidate/calendar2023_2026_excess.csv'
