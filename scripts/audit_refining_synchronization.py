...
OUT = ROOT / "evidence/refining-synchronization-20260912"
...
def main():
    ...
    protocol = {
        ...
        "quote_policy": "latest raw record by receive time, including invalid states; no last-good substitution",
    ...
    pd.DataFrame(all_rows).to_parquet(OUT / "grid_audit.parquet", index=False)
