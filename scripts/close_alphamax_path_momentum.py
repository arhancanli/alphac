...
OUT = ROOT / "artifacts/analysis/alphamax_path_momentum_20260913"
...
def main():
    ...
    limitation = (
        "Retrospective standalone path candidate, not untouched OOS or combined qualification. "
    ...
    files += [
        ...
        Path(__file__),
        ROOT / "scripts/audit_alphamax_path_accounting.py",
    ]
    ...
    write(
        ...
        {
            "status": "ALPHAMAX_PATH_CANDIDATE_ACCOUNTED_PACKET_CLOSED",
            "qualified": False,
