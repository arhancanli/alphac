...
def main():
    ...
    parser.add_argument("arm", choices=["baseline", "baseline_stress", "momentum", "momentum_stress", "momentum_sigma", "momentum_sigma_stress"])
    ...
    files += [
        ...
        Path(__file__),
        ROOT / "scripts/audit_alphamax_share_ratio.py",
    ]
