...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'artifacts/analysis/bil_cash_20260913'
...
def close(arm):
 ...
 'code_environment_and_reproduction':'269 hash-bound inputs/code files; eight synthetic ledger tests passed. Independent cumulative cash/share/issuer entitlement audit checks 1248 days. Not independent full environment reproduction.',
 ...
 research_family_key='bil_cash_implementation',packet_status='COMPLETE_DIAGNOSTIC_ACCOUNTING_NOT_ADMITTED',
