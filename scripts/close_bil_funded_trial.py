...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'artifacts/analysis/bil_funded_account_20260913'
...
def close(arm):
 ...
 claims={
 'admission_or_kill_decision':'Diagnostic arm measured and accounted; combined design requires both arms and separate 2022 evaluation before reference adoption. No admission.',
 'code_environment_and_reproduction':'271 hash-bound inputs/code files; eight synthetic ledger tests passed. Independent cumulative cash/share/issuer entitlement audit checks 1248 days. Not independent full environment reproduction.',
 'economic_mechanism_and_falsifiable_hypothesis':'Allocate32500 actual initial cash to BIL with no inter-sleeve transfers; monthly integer buys, issuer dividend receivables. No alpha-sleeve novelty claim.',
 ...
 'family_and_union_trial_accounting':'Canonical reservation and immutable standalone funded measurement retained. Cash-subbook ledger belongs to this implementation identity, not a qualified new alpha sleeve. Failed preflight attempts preserved.',
 ...
 'result_uncertainty_stress_capacity_and_diversification':'Retrospective standalone funded cash account; daily statistics, not intraday risk. Source/cost/collateral/rebalancing limitations remain. This arm passes or fails only its saved gates; not untouched OOS, capacity,15-sleeve or launch evidence.'}
 ...
 research_family_key='bil_funded_account',packet_status='COMPLETE_DIAGNOSTIC_ACCOUNTING_NOT_ADMITTED',
 ...
 claim_boundary='Cash implementation diagnostic only. Combined design and separate2022 gates required; no admission or reference adoption.',
