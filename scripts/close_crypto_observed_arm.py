...
"""
    ...
    files += [
        ...
        Path(__file__),
        ROOT / "scripts/audit_crypto_observed_accounting.py",
        ROOT / "scripts/audit_crypto_observed_horizon.py",
        ROOT / "scripts/audit_crypto_observed_boundaries.py",
    ]
