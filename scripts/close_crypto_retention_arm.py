...
"""
    ...
    files += [
        ...
        Path(__file__),
        ROOT / "scripts/audit_crypto_retention_accounting.py",
        ROOT / "scripts/audit_crypto_retention_horizon.py",
        ROOT / "scripts/audit_crypto_retention_boundaries.py",
    ]
