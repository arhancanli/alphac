...
"""
    ...
    files += [
        ...
        Path(__file__),
        ROOT / "scripts/audit_crypto_risk_rank_accounting.py",
        ROOT / "scripts/audit_crypto_risk_rank_horizon.py",
        ROOT / "scripts/audit_crypto_risk_rank_boundaries.py",
    ]
    ...
    write(
        ...
        {
            "status": "EXTENDED_ARM_RECONCILED_PACKET_CLOSED",
            "qualified": False,
