...
OUT=ROOT/'artifacts/analysis/combined_crypto_observed_carry_20260913'
CONTROL=ROOT/'artifacts/analysis/combined_session_cooldown_20260913'
SPEC=ROOT/'evidence/combined-crypto-observed-carry-20260913/EXPERIMENT_SPEC.json'
...
def main():
    ...
    passed=all(checks.values());decision='PASS_BROADER_GATES_REQUIRE_SEPARATE_2022_CHECK' if passed else 'FAIL_STOP_OBSERVED_CADENCE_FAMILY_NO_WINDOW_SWEEP'
    ...
    report='# Combined observed-cadence crypto carry comparison\n\nFrozenJan2023–June1 2026; only crypto carry annualization changes. AlphaMax,confirmedTrend,benchmark and cash contributions exactly unchanged on every date.\n\n| Metric | Baseline | Candidate | Baseline stress | Candidate stress |\n|---|---:|---:|---:|---:|\n'
    ...
    report+=('Next: separately preregister2022 normal/stress validation of the same observed-cadence rule; no promotion yet. ' if passed else 'Stop this observed-cadence family as preregistered. Preserve candidate and baseline; do not sweep nearby windows or relax annual gates. Pivot to independent alpha research. ')
