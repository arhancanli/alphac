...
DESIGN = ROOT / "evidence/alphamax-extended-reference-20260913/EXPERIMENT_SPEC.json"
...
def execute(arm_id):
    ...
    reservation.update(
        ...
        family_trial_account="alphamax_extended_reference",
        return_identity_id=f"alphamax_extended_reference_{arm_id}_20260913",
        packet_public_path=f"/glassbox/trial-packets/alphamax-extended-reference-{arm_id}-20260913",
        paper_public_path=f"/research/alphamax-extended-reference-{arm_id}-20260913",
    )
