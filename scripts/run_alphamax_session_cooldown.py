...
DESIGN = ROOT / "evidence/alphamax-session-cooldown-20260913/EXPERIMENT_SPEC.json"
...
def execute(arm_id):
    ...
    reservation.update(
        ...
        family_trial_account="alphamax_session_cooldown",
        return_identity_id=f"alphamax_session_cooldown_{arm_id}_20260913",
        packet_public_path=f"/glassbox/trial-packets/alphamax-session-cooldown-{arm_id}-20260913",
        paper_public_path=f"/research/alphamax-session-cooldown-{arm_id}-20260913",
    )
