...
def execute():
    ...
    write(OUT / "cost_policy.json", {"basis": policy.basis, "rows": binding["rows"]})
    evidence_paths = {
    ...
    reservation = {
        ...
        "return_identity_id": "alphatrend_cost_gate_development_20260911",
        "hypotheses_spent": 1,
        "trial_config": config,
        "hypothesis_identity": hypothesis_hash(config),
        "packet_public_path": "/glassbox/trial-packets/alphatrend-cost-gate-development-20260911",
        "paper_public_path": "/research/alphatrend-cost-gate-development-20260911",
        "evidence": {
