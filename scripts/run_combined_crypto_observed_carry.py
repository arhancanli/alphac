...
CRYPTO = ROOT / "artifacts/analysis/crypto_observed_carry_20260913"
VINTAGE = (
...
def inputs():
    ...
    paths.append(ROOT/'evidence/crypto-observed-carry-20260913/EXPERIMENT_SPEC.json')
...
def execute(arm):
    ...
    config = {
        "family": "combined_crypto_observed_carry",
        "arm": arm,
    ...
    reservation.update(
        ...
        family_trial_account="combined_crypto_observed_carry",
        return_identity_id=f"combined_crypto_observed_carry_{arm}_20260913",
        packet_public_path=f"/glassbox/trial-packets/combined-extended-reference-{arm}",
        paper_public_path="/research/combined-crypto-observed-carry-20260913",
    )
