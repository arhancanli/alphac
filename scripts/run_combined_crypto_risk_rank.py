...
CRYPTO = ROOT / "artifacts/analysis/crypto_risk_normalized_rank_20260913"
VINTAGE = (
...
def inputs():
    ...
    paths.append(ROOT/'evidence/crypto-risk-normalized-rank-20260913/EXPERIMENT_SPEC.json')
...
def execute(arm):
    ...
    config = {
        "family": "combined_crypto_risk_rank",
        "arm": arm,
    ...
    reservation.update(
        ...
        family_trial_account="combined_crypto_risk_rank",
        return_identity_id=f"combined_crypto_risk_rank_{arm}_20260913",
        packet_public_path=f"/glassbox/trial-packets/combined-extended-reference-{arm}",
        paper_public_path="/research/combined-crypto-risk-rank-20260913",
    )
