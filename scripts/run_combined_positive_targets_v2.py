...
OUT = ROOT / "artifacts/analysis/alphac_positive_targets_20260913_attempt2"
SPEC = ROOT / "evidence/alphac-positive-targets-20260913-attempt2/EXPERIMENT_SPEC.json"
...
def main():
    ...
    assert ExperimentUnion.discover(OUT / "baseline/experiments.jsonl", ROOT).n_hypotheses() == 261
    ...
    for arm in ARMS:
        ...
        reservation.update(
            ...
            return_identity_id=f"alphac_positive_targets_{arm}_20260913_attempt2",
        ...
        evidence = {
            ...
            "runner": ROOT / "scripts/run_combined_positive_targets_v2.py",
