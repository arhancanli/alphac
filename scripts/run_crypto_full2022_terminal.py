...
DESIGN = ROOT / "evidence/crypto-full2022-terminal-20260913/EXPERIMENT_SPEC.json"
...
def execute(arm_id):
    ...
    reservation.update(
        ...
        family_trial_account="crypto_full2022_extension",
        return_identity_id=f"crypto_full2022_{arm_id}_20260913",
        packet_public_path=f"/glassbox/trial-packets/crypto-full2022-{arm_id}-20260913",
        paper_public_path=f"/research/crypto-full2022-{arm_id}-20260913",
    )
