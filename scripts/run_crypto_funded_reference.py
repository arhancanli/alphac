...
OUT = ROOT / "artifacts/analysis/crypto_funded_reference_20260913"
DESIGN = ROOT / "evidence/crypto-funded-reference-20260913/EXPERIMENT_SPEC.json"
...
def prepare():
    ...
    files += [ROOT/"scripts/funded_inception_runner.py", ROOT/design["funded_policy"], ROOT/"artifacts/research/forecast_diagnostics/selection_debt_20260913.json"]
...
def execute(arm_id):
    from funded_inception_runner import FundedInceptionRunner as WalkForwardRunner
    ...
    reservation.update(
        ...
        family_trial_account="crypto_funded_reference",
        return_identity_id=f"crypto_funded_reference_{arm_id}_20260913",
        packet_public_path=f"/glassbox/trial-packets/crypto-funded-reference-{arm_id}-20260913",
        paper_public_path=f"/research/crypto-funded-reference-{arm_id}-20260913",
    )
