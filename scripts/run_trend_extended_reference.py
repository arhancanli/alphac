...
SPEC = ROOT / "evidence/trend-extended-reference-20260913/EXPERIMENT_SPEC.json"
...
def main():
        ...
        write(
            OUT / "protocol.json",
            {
                ...
                "baseline_replay_reason": (
                    "Fresh state on fixed later horizon; not exact2015-start replay"
                ),
                "baseline": str(SAVED),
    ...
    for arm, positive_targets, stress in [
        ...
        reservation.update(
            ...
            family_trial_account="confirmed_trend_extended_reference",
            return_identity_id=f"trend_extended_reference_{arm}_20260913",
            packet_public_path=f"/glassbox/trial-packets/trend-extended-reference-{arm}-20260913",
            paper_public_path=f"/research/trend-extended-reference-{arm}-20260913",
        )
