...
class PayableEquityBacktester(EventDrivenBacktester):
    def __init__(
        self, *args, payments, retrospective_vintage_ms=None, retrospective_actions=None, **kwargs
    ):
