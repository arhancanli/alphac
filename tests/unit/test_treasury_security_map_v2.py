...
def test_fungible_two_year_reopening_keeps_identity():
    r = note(
        cusip="FUNGIBLE", security_term="2-Year", original_security_term="5-Year", reopening="Yes"
    )
    assert classify(r) == "note_2y"
    assert issued_candidate([r], "2020-01-16", "note_2y")["cusip"] == "FUNGIBLE"
